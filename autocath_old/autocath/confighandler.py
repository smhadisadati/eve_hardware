...
class ConfigHandler:
    ...
    def load_config_dict(self, file: str):
        try:
    ...
    def save_config_dict(self, config_dict: dict, file: str):
    ...
    def _dict_to_obj(
        ...
        for str_replace in class_str_replace:
            class_str = class_str.replace(str_replace[0], str_replace[1])
